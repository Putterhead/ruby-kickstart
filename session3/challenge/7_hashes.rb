...
#                      </ol>
# strangely, this doesn't pass the examples, although I hashed it out and tried 
# copying and pasting the solution, it still didn't pass.
# This is the error received,
# expected "<li >baseball</li>" to match /<li\s+style=('|")color:#FF0000;(\1)\s*>baseball<\/li>/i
#        Diff:
#        @@ -1,2 +1,2 @@
#        -/<li\s+style=('|")color:#FF0000;(\1)\s*>baseball<\/li>/i
#        +"<li >baseball</li>"
